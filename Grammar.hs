...
happyExpList = Happy_Data_Array.listArray (0,56) ([2048,0,8,32768,0,512,0,0,128,3072,0,8,3072,0,256,0,4,4128,4096,0,0,0,1,8,2048,0,2056,0,64,12,0,0,0,0,32,512,16384,0,512,0,0,0,0,0,0,2048,8,0,0,64,32,2048,8,0,0,0,64,0,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parseCalc","Prog","VarList","StrictVarList","VarItem","ConstraintList","Constraint","NumList","rel","var","'='","'('","')'","'{'","'}'","','","';'","'_'","'['","']'","num","%eof"]
        bit_start = st * 24
        bit_end = (st + 1) * 24
...
action_10 (19) = happyShift action_19
...
action_15 (12) = happyShift action_3
...
action_22 (22) = happyShift action_33
...
action_30 (12) = happyShift action_26
...
action_34 (7) = happyGoto action_25
...
happyReduction_11 (_ `HappyStk`
	...
	_ `HappyStk`
	(HappyTerminal (TokenRel _ happy_var_1)) `HappyStk`
	happyRest)
	 = HappyAbsSyn9
		 (ConstraintRel happy_var_1 happy_var_3
	) `HappyStk` happyRest
...
happyReduction_12 (_ `HappyStk`
	...
	happyRest)
	 = HappyAbsSyn9
		 (ConstraintRelEnhanced happy_var_1 happy_var_3 happy_var_6
	) `HappyStk` happyRest
...
happyReduction_14 (HappyTerminal (TokenNum _ happy_var_1))
	 =  HappyAbsSyn10
		 ([happy_var_1]
	)
...
happyReduction_15 (HappyAbsSyn10  happy_var_3)
	_
	(HappyTerminal (TokenNum _ happy_var_1))
	 =  HappyAbsSyn10
		 (happy_var_1 : happy_var_3
	)
...
happyNewToken action sts stk (tk:tks) =
	...
	case tk of {
	TokenRel _ happy_dollar_dollar -> cont 11;
	...
	TokenOpenSqr _ -> cont 21;
	TokenCloseSqr _ -> cont 22;
	TokenNum _ happy_dollar_dollar -> cont 23;
	_ -> happyError' ((tk:tks), [])
	}
